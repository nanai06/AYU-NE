...
<body>
    ...
    <div class="content">
        ...
        <div class="list-view active" id="listView">
            ...
            {{-- Lokasi 1: Alfamart Sudirman --}}
            <div class="location-card" data-name="alfamart sudirman" style="position: relative;">
                <img class="location-photo" src="https://images.unsplash.com/photo-1578916171728-46686eac8d58?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Alfamart">
                <div class="location-info">
                    <div style="display:flex; align-items:center; gap:8px;">
                        <span class="location-name">Alfamart Sudirman</span>
                        {{-- Tag "Terdekat" hanya muncul di lokasi pertama --}}
            ...
            <div class="location-card" data-name="indomaret thamrin" style="position: relative;">
                <img class="location-photo" src="https://images.unsplash.com/photo-1710905284916-74c42985384e?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Indomaret">
                <div class="location-info">
                    <div style="display:flex; align-items:center; gap:8px;">
            ...
            <div class="location-card" data-name="guardian grand indonesia" style="position: relative;">
                <img class="location-photo" src="https://images.unsplash.com/photo-1559171667-74fe3499b5ba?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Guardian">
                <div class="location-info">
                    <div style="display:flex; align-items:center; gap:8px;">
                ...
                <span class="location-distance" style="position:absolute; top:16px; right:16px;">2.1 km</span>
