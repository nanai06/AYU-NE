...
<div class="content">
        ...
        <div class="section-box">
            ...
            <div class="kurir-option selected" onclick="pilihKurir(this,15000)">
                <div class="kurir-left">
                    ...
                    <div><div class="kurir-name">JNE REG</div><div class="kurir-hari">Estimasi 2–3 hari kerja</div></div>
                </div>
            ...
            <div class="kurir-option" onclick="pilihKurir(this,12000)">
                <div class="kurir-left">
                    ...
                    <div><div class="kurir-name">J&T Express</div><div class="kurir-hari">Estimasi 2–4 hari kerja</div></div>
                </div>
            ...
            <div class="kurir-option" onclick="pilihKurir(this,18000)">
                <div class="kurir-left">
                    <div class="radio-circle"></div>
                    <div><div class="kurir-name">SiCepat REG</div><div class="kurir-hari">Estimasi 1–2 hari kerja</div></div>
                </div>
                <div class="kurir-harga">Rp 18.000</div>
            </div>
            <div class="kurir-option" onclick="pilihKurir(this,20000)">
                <div class="kurir-left">
                    <div class="radio-circle"></div>
                    <div><div class="kurir-name">Anteraja</div><div class="kurir-hari">Estimasi 1–3 hari kerja</div></div>
                </div>
                <div class="kurir-harga">Rp 20.000</div>
            </div>
        </div>
    ...
    <div class="checkout-right">
        <div class="summary-box">
            ...
            <a href="{{ route('pesanan-berhasil') }}" class="btn-pesan">
