        ...
        <div style="display:grid; grid-template-columns:2fr 1fr; gap:24px;">
            ...
            <div>
                <div id="btnScanWrap" style="margin-bottom:16px;">
                    <button type="button" onclick="startScanner()"
                        style="width:100%; min-height:195px; border:2px dashed #e07080; border-radius:12px; background:white; display:flex; flex-direction:column; justify-content:center; align-items:center; gap:8px; cursor:pointer;">
                ...
                <input type="text" id="kodeInput" class="input-kode" placeholder="Masukkan kode drop box...">
            ...
            <div style="display:flex; flex-direction:column; gap:16px;">
                ...
                <form method="POST" action="{{ route('proses-qr') }}" id="formKonfirmasi">
                    ...
                    <button id="btnKonfirmasi" class="confirm-btn" disabled>
                        Konfirmasi
                    </button>
                </form>
            </div>
