...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .banner-wrapper { position: relative; border-radius: 20px; overflow: hidden; height: 260px; width: 100%; }
        .banner-slide { display: none; width: 100%; height: 100%; position: absolute; top: 0; left: 0; background-size: cover; background-position: center; align-items: flex-end; justify-content: flex-start; flex-direction: column; padding: 0; }
        .banner-slide.active { display: flex; }
        .banner-slide::before { content: ''; position: absolute; inset: 0; background: linear-gradient(90deg, rgba(30,8,16,0.22) 0%, rgba(30,8,16,0.05) 60%, transparent 100%); border-radius: 20px; z-index: 1; }
        .banner-content { position: absolute; z-index: 2; left: 8%; bottom: 32px; max-width: 440px; }
        .banner-tag { font-size: 11px; font-weight: 600; letter-spacing: 2px; color: #b85c65; text-transform: uppercase; margin-bottom: 8px; display: block; }
        .banner-slide h2 { font-size: 32px; font-weight: 800; color: #3b1a1a; line-height: 1.15; margin-bottom: 10px; }
        .banner-slide h2 em { font-style: italic; color: #b85c65; }
        .banner-slide p { font-size: 13px; color: #7a4a4a; line-height: 1.6; margin-bottom: 18px; max-width: 360px; }
...
<div class="banner-section">
    <div class="banner-wrapper">
        ...
        <div class="banner-slide active" style="background: linear-gradient(135deg, #FFBBC0 0%, #FFEEEE 60%, #FFBBC0 100%);">
            <div class="banner-content">
                <span class="banner-tag">Ayu Belanja • Diskon</span>
                <h2>Diskon Hingga<br><em>50% Off!</em></h2>
                <p>Produk kecantikan preloved & baru terverifikasi dengan harga terbaik.</p>
                <a href="#productGrid" class="banner-cta">Belanja Sekarang</a>
            </div>
        </div>
        <div class="banner-slide" style="background: linear-gradient(135deg, #fde0d8 0%, #ffcabe 60%, #ff8d70 100%);">
            <div class="banner-content">
                <span class="banner-tag">Preloved • Terverifikasi</span>
                <h2>Produk Asli,<br><em>Kualitas Terjamin</em></h2>
                <p>Setiap produk dicek keaslian dan kualitasnya oleh tim AYU-NE.</p>
                <a href="#productGrid" class="banner-cta">Lihat Produk</a>
            </div>
        </div>
        <div class="banner-slide" style="background: linear-gradient(135deg, #dbf5e0 0%, #9dc69c 60%, #598f4e 100%);">
            <div class="banner-content">
                <span class="banner-tag" style="color:#2D5016;">Eco Beauty • Preloved</span>
                <h2 style="color:#1f3e0b;">Cantik Sambil<br><em style="color:#4e7434;">Jaga Bumi</em></h2>
                <p style="color:#2D5016;">Belanja produk preloved, kurangi sampah kemasan kosmetik.</p>
                <a href="{{ route('ayu-daur-ulang') }}" class="banner-cta" style="background:#2D5016;">Daur Ulang</a>
            </div>
        </div>
...
<script>
    ...
    function nextBanner() { goBanner((currentBanner + 1) % bannerSlides.length); }
    function prevBanner() { goBanner((currentBanner - 1 + bannerSlides.length) % bannerSlides.length); }
